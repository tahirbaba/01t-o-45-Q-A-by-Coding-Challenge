...
let places = ["Peshawer", "Kalam", "Sawat", "Malakund", "Kumrat"];
...
let guest1 = ["Muhammad Shakil", "Muhammad Ibrahim", "Muhammad Raof", "Muhammad Mansoor", "Owais Baloch"];
...
let countries = ["Makkah", "Madina", "Misr", "Yamun"];
...
let friends = ["Owais Ahmed", "Ehsan Ayyub", "Taimour"];
...
let favorite_fruits = ["Mangoes", "Oranges", "Apples"];
...
let usernames = ["admin", "Naseer Ahmed Sahb", "Shoukat Sahb", "Abdul Qadir Sahb", "Imran Sahb"];
...
let current_users = ["shakeel", "admin", "zubair", "taimoor", "faheem"];
let new_users = ["Mustufa", "Zeshan", "owais", "admin", "Ibrahim"];
...
let pizzas = ["California", "Subway", "kabab Bakers"];
...
function make_shirt1(size = "large", message = "TypeScript") {
...
let naatKhuwans = ["Owais Raza Qadri", "Khawar Naqshbandi", "Bilal Qadri"];
function show_naatKhuwans(naatKhuwans) {
